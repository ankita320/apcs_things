public class MyStrings
{
    public static void main(String[] args)
    {
       ...
       // What is the outuput? people
       // Are characters 4 and 10 included? 4 is included but 10 is not.
       // Print the lenght of firstSub 6
       System.out.println(firstSubs.length());

       String secondSubs = msg.substring(41);
       System.out.println("msg.substring(41): " + secondSubs);
       // What is the outuput? they can change the world are the ones who do.
       // Is the character 41 included? yes
       // Print the lenght of secodSubs 46
       System.out.println(secondSubs.length()); 

       // Get and print the word people
       System.out.println(firstSubs);
       ...
       System.out.println("firstSubs.equals(secondSubs): " + firstSubs.equals(secondSubs));
        // What is the result of the comparisson? false
        // Create a new String object newStr and assign a value. Requirement: firstSubs.equals(newStr) should be True
        String newStr = firstSubs;
       
        // REMEMBER DO NOT USE == TO COMPARE STRINGS

        System.out.println( "msg.charAt(0) is: " + msg.charAt(0));
        // What is the output? T
        // Print the last character of msg using the method charAt() blc characters r primitive types
        System.out.println( "msg.charAt(0) is: " + msg.charAt(msg.length() - 1));
        // YOU CAN COMPARE CHARACTERS USING == blc characters r primitive tyepe
